...
<h3 align="center">QA Automation Engineer | Python · Pytest · BDD · CI/CD</h3>
...
<p align="left">
<a href="https://www.linkedin.com/in/uriel-alejandro-perez-valdovinos-b3b6692a4/" target="blank">
...
<h3 align="left">QA & Automation Stack:</h3>
<p align="left">
...
|---------|-------------|-------|
| [weather-bdd-tests](https://github.com/uriel-P-V/weather-bdd-tests) | BDD test suite for Open-Meteo API with Gherkin scenarios, mocking and CI/CD | Behave · Requests · GitHub Actions |
| [notification-test-suite](https://github.com/uriel-P-V/notification-test-suite) | Contract testing for notification system with dependency injection | Pytest · unittest.mock |
| [storage-test-automation](https://github.com/uriel-P-V/storage-test-automation) | Automated tests for storage API with performance benchmarks | Pytest · SQLite · Benchmark |
